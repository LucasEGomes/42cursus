...
/*   Updated: 2022/10/31 21:08:15 by luceduar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*put_exit(t_asset *assets, t_map_element *element, t_map *map)
{
	...
	{
		player = get_frame(assets->player_walk, PLAYER_WALK_FRAMES, assets->tick, assets->cycle);
...
void	*put_player(t_asset *assets, t_map_element *element, t_map *map)
{
	...
	(void) element;
	(void) map;
	frame = get_frame(assets->player_walk, PLAYER_WALK_FRAMES, assets->tick, assets->cycle);
